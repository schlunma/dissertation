...
representation of mixed-phase clouds above the Southern Ocean. This change
leads to an improved simulation of the shortwave \ac{CRE} in these models when
...
the affected \acs{CMIP}6 models, this cloud phase change due to warming is
