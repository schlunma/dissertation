...
In a first analysis, the climate sensitivity metrics \ac{ECS} and \ac{TCR} are
...
number of ways. This final \namecref{sec:07:outlook} presents several
suggestions on possible ways forward.

\Cref{ch:04:papers_ecs_tcr_assessment} presents two possible reasons for the
...
Due to the flexibility of the new \ac{ML}-based climate model weighting
...
\acl{T} over the \nth{21} century in the \ac{SSP} scenarios. A relevant study
...
\nth{21} century based on observable process-based predictors of today's
