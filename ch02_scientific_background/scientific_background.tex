...
thesis, the most relevant source for these is the climate response uncertainty.
It originates from the different responses of the different climate models in a
multi-model ensemble to a given forcing and affects all multi-model projections
of the future climate (\eg{} the climate sensitivity or the future development
of the global carbon cycle). This section introduces three state-of-the-art
techniques to reduce uncertainties in multi-model climate model projections
with observations. The presented methods form the baseline for the work
