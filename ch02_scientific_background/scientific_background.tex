...
A further example of an emergent constraints on the carbon cycle focuses on
...
An alternative approach to emergent constraints are climate model weighting
schemes. Their basic idea is to abandon model democracy by replacing the
arithmetic mean used to calculate the \acp{MMM} by a weighted mean of the form
\begin{equation}
...
Due to its flexibility, the climate model weighting scheme given by
\cref{eq:02:knutti_weights} has already been used for various target variables:
