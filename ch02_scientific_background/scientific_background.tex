...
\section{Techniques to Reduce Uncertainties in Multi-Model Climate Projections
  with Observations}
\label{sec:02:techniques_to_reduce_uncertainties}
...
observations. These techniques form the baseline of the work presented in the following chapters.


\subsection{Emergent Constraints}
\label{subsec:02:emergent_constraints}

- equations for emergent constraints, see Schlund ESD, following Cox 2013

- Flat prior, see Schlund ESD
