...
After a brief overview of the \acs{ESMValTool}'s structure
(\cref{sec:03:esmvaltool}), this \namecref{ch:03:esmvaltool} presents all these
contributions that are not documented in other
\namecrefs{ch:04:papers_ecs_tcr_assessment} of this thesis and puts them into
context
...
The absorbed shortwave radiation (\emph{asr}) is defined as the difference in
...
illustrating \emph{co2s} is given in \cref{fig:03:co2s}. \Cref{fig:03:co2s:a}
...
\Cref{fig:03:co2s:b} shows the monthly mean \emph{co2s} at Mauna Loa, Hawaii
...
of the \acs{IPCC}'s Fifth \acl{AR} (\acs{AR}5) \autocite{Flato2013}. For this
