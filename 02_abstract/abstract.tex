...
optimal mitigation and adaptation strategies. \AcfpAbstract{ESM}, which are
...
projections from \acsp{ESM} participating in the \acfAbstract{CMIP} and the
...
range of $\rangeunit{1.5}{4.5}{K}$ assessed by the \acfAbstract{IPCC} Fifth
