...
\begin{table}[!h]
  ...
  \caption[
    ...
    individual variables used for each emergent constraint.
  }
...
variance. In total, 237,852 (16,503) training data points, 79,284 (5501)
hold-out test data points, and 46,344 (3727) points for the prediction are used
in the machine learning model for Step 2a (Step 2b).
