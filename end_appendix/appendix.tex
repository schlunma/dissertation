...
\begin{table}[p]
  ...
  \begin{tabulary}{\columnwidth}{L L L}
    ...
    A & B & C \\
    \midrule
    111111111111111111111111111111111111111111111 & 2 & 3 \\
    \bottomrule
  \end{tabulary}
  \caption{\acs{CMIP}5. \AdaptedFrom{Schlund2020a}.}
  \label{tab:app:a:emergent_constraints_cmip5}
\end{table}
...
\begin{table}[p]
  ...
  \begin{tabulary}{\columnwidth}{L L L}
    ...
    \bottomrule
  \end{tabulary}
  \caption{\acs{CMIP}6. \AdaptedFrom{Schlund2020a}.}
  \label{tab:app:a:emergent_constraints_cmip6}
\end{table}
