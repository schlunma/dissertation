...
reasons for the increased climate sensitivity in the \acs{CMIP}6 ensemble is
given in \cref{sec:04:possible_reasons_high_ecs_cmip6}.
...
Ocean that are present in earlier \ac{CMIP} generations (\eg{} \acs{CMIP}5). As
the climate warms, the predominantly ice clouds over the Southern Ocean in
these climate models become liquid clouds \autocite{McCoy2015}. As a result,
the cloud will get more reflective to the incoming solar radiation since a
cloud consisting of smaller liquid droplets reflects more sunlight than a cloud
consisting of larger ice crystals (for a fixed water content). In addition,
predominantly liquid clouds tend to precipitate less than mixed-phase clouds
(composed of liquid water and ice), leading to more liquid water that stays in
the cloud. Overall, this forms a strong negative shortwave cloud feedback over
the Southern Ocean in climate models from previous \ac{CMIP} generations.
...
over the present-day Southern Ocean. Moreover, this reduction of the negative
shortwave cloud feedback increases the global net cloud feedback
\autocite{BodasSalcedo2019, Tan2016} and eventually the \ac{ECS} of the
affected \acs{CMIP}6 models \autocite{Andrews2019, Gettelman2019}.
...
extratropics. Moreover, \textcite{Zelinka2020} show that this mainly results
from an increase in the liquid condensate fraction in the \acs{CMIP}6 clouds
for the pre-industrial and present‐day periods, leading to the aforementioned
