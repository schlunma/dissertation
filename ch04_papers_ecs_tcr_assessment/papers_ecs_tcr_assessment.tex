...
\begin{table}[!t]
  ...
  \csvreader[ECSAndTCRTable]{
    ...
    \dataset & $\idx$ & $\ecs$ & $\tcr$}
  \caption[
    \Acf{ECS} and \acf{TCR} evaluated for the \acs{CMIP}5 models.
  ]{
    \Acf{ECS} and \acf{TCR} evaluated for the \acs{CMIP}5 models. Details on
    the calculation of \acs{ECS} and \acs{TCR} are given in
...
\begin{figure}[t]
  ...
  \caption[
    ...
    liquid clouds \autocite{BodasSalcedo2019, Gettelman2019, Mulcahy2020,
      Williams2020}. Thus, in these models a cloud phase change due to global
    warming is no longer possible, which removes (or significantly reduces) the
    strong negative cloud phase change feedback (orange arrows). This leads to
    an increase in the global net cloud feedback \autocite{BodasSalcedo2019,
      Tan2016} and the \acf{ECS} in the corresponding \acs{CMIP}6 models
    \autocite{Andrews2019, Gettelman2019}, which is a possible explanation for
    the high \acs{ECS} values found in many \acs{CMIP}6 models.
  }
