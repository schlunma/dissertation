...
increase of climate sensitivity in the \acs{CMIP}6 models are discussed in
detail (\cref{sec:04:possible_reasons_high_ecs_cmip6}).
...
\begin{table}[!t]
  ...
  \caption{\acf{ECS} and \acf{TCR} evaluated for the \acs{CMIP}5 models.
    ...
    number of models). \AdaptedFrom{Meehl2020}.}
...
To illustrate the results of the previous section and put them into historical
