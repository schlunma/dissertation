...
first introduce the eleven emergent constraints on \acs{ECS} and evaluate them
on \acs{CMIP}5 and \acs{CMIP}6 data
(\cref{sec:05:comparison_of_emergent_constraints}). After that, we provide a
discussion of the results and draw important conclusions from them
(\cref{sec:05:discussion_and_conclusions}).
