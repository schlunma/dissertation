...
previous \namecref{ch:04:papers_ecs_tcr_assessment} begs the question about the
...
\begin{table}[!t]
  ...
  \caption[
    ...
    \namecref{ch:05:paper_ecs}. Detailed descriptions of the variables used to
...
In this \namecref{ch:05:paper_ecs}, we first introduce the data (climate model
...
In this \namecref{sec:05:comparison_of_emergent_constraints} we describe and
...
As shown in the previous \namecrefs{sec:05:comparison_of_emergent_constraints},
...
In this \namecref{sec:05:discussion}, we discuss possible reasons for, and
...
In this \namecref{ch:05:paper_ecs}, 11 different emergent constraints on
