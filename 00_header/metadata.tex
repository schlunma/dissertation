...
\newcommand*{\TheKeywords}{%
  Climate Change\sep Climate Modeling\sep Climate Projections\sep
  Climate Sensitivity\sep Climate Model Weighting\sep Emergent Constraints\sep
  Machine Learning%
}
...
\newcommand*{\TheAbstract}{%
  ...
  dioxide (CO2) concentration, a multi-model mean (MMM) of 3.74 K and a
