...
anthropogenic drivers, there are also natural processes that impact the climate
system like changes in solar activity or volcanic eruptions. However, there is
clear evidence that these natural drivers alone cannot explain the observed
climate change \autocite{Haustein2017}.
...
This thesis aims to reduce to reduce uncertainties in multi-model climate
...
list of these publications is given on \cpageref{ch:bib:own}. Wherever material
...
from \acs{CMIP}5 models. The content of this \namecref{ch:05:paper_ecs} is
