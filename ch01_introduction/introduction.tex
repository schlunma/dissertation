...
anthropogenic fossil fuel emissions since the mid-\nth{18} century
...
concentration (\eg{} an instantaneous doubling of \ac{CO2} or \iac{CO2}
...
response of the system to \iac{CO2} doubling. In \acs{AR}5, the assessed range
...
This thesis aims to reduce uncertainties in multi-model climate projections
with observations by addressing the following three
\lcnamecrefs{enum:01:question_1}:
...
Parts of this thesis are already published in multiple peer-reviewed journals
(two first-author studies and six co-author studies). A complete list of these
publications is given on \cpageref{ch:bib:own}. Wherever material from these
...
involved contributors. However, unless stated otherwise, all content from these
publications (text, figures, and tables) shown in this thesis originates from
the author of this thesis. A detailed list of contributions to these studies is
given in the corresponding \lcnamecrefs{ch:03:esmvaltool}.
...
\autocite{Eyring2020, Lauer2020, Righi2020, Weigel2021}.
\Cref{ch:04:papers_ecs_tcr_assessment} covers the assessment of climate
...
from \acs{CMIP}5 models. The content of this \lcnamecref{ch:05:paper_ecs} is
...
at the end of the \nth{21} century, which is already published in the
